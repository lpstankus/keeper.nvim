...
function M.get(c)
  return {
    ...
    LineNr       = { fg = c.alt0, bg = c.bg0 },
    CursorLineNr = { fg = "#ffffff", bold = true },
    LineNrAbove  = "LineNr",
    LineNrBelow  = "LineNr",

    SignColumn   = { fg = c.fg0,  bg = c.bg0 },
    ...
    DiagnosticError                  = { fg = c.err, bg = c.bg0 },
    DiagnosticWarn                   = { fg = c.war, bg = c.bg0 },
    DiagnosticOk                     = { fg = c.suc, bg = c.bg0 },
    DiagnosticHint                   = { fg = c.hin, bg = c.bg0 },
    DiagnosticInfo                   = { fg = c.hin, bg = c.bg0 },
    DiagnosticUnnecessary            = { fg = c.hin, bg = c.bg0 },
