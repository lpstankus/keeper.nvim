...
function M.get(c)
  return {
    ...
    MiniStatuslineFilename    = { fg = c.foreground_function, bg = c.background_secondary, bold = true },
    ...
    MiniStatuslineModeCommand = { fg = c.background, bg = c.accent_str, bold = true },
